...
shinyUI(navbarPage("Visualisering och faktoranalys av SVTs valkompass inför riksdagsvalet 2014",
                   tabPanel("Personnivå",
  sidebarPanel(
    selectInput(
      "fargsattning",
  ...
  tabPanel("Om",
              helpText("Denna visualisering är byggd av Staffan Betnér (@staffanbetner). Rådatat kommer från SVT Pejl.
    Samtliga individers placeringar är skattade med en två-dimensionell nominell IRT-modell, en slags faktoranalys (se Wikipedia) för kategorivariabler."),
              helpText("Skalorna är inte konceptuella/ideologiska, utan bygger på hur olika åsikter hänger ihop hos samtliga riksdagskandidater. 
